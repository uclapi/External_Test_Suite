...
RUN cd /home/seluser && sudo apt-get install python3-pip -y && pip3 install -r requirements.txt && sudo chmod 0644 /etc/cron.d/oauth-cron && crontab /etc/cron.d/oauth-cron && sudo rm -rf /var/lib/apt/lists/*
